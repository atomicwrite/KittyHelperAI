...
namespace KittyHelper.ServiceGenerators
{
        ...
        public static partial class KittyServiceHelper
        {
            ...
            public static string CreateDeleteByIdEndpointServiceClass(Type t, CreateDeleteByIdEndPointOptions options = null)
            {
            ...
            public static string CreateDeleteByIdEndpointRequestClass(Type t, CreateDeleteByIdEndPointOptions options = null)
            {
                StringBuilder str = new();
                options ??= new CreateDeleteByIdEndPointOptions(t);
            ...
            public static string CreateDeleteByIdEndpointResponseClass(Type t, CreateDeleteByIdEndPointOptions options = null)
            {
                StringBuilder str = new();
                options ??= new CreateDeleteByIdEndPointOptions(t);
